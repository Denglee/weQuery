		...
		<div style="padding-top: 30px">
			...
			<div v-else class="btn-manager">
				...
				<van-button type="primary" class="btnTel btnCode" @click="funCodePopup()"
				            v-if="userWxQrUrl ">
<!--				            v-if="detailsArr.contactDo.qrimg != '' ">-->
					<van-icon name="coupon-o" />
					二维码
				</van-button>

				<a :href="'tel:' + detailsArr.contactDo.telephone" class="btnTel">
<!--				<a :href="'tel:' + userPhone" class="btnTel">-->
...
<!--			<van-image :src="detailsArr.contactDo.qrimg" class="detaile-code"></van-image>-->
			<van-image :src="userWxQrUrl" class="detaile-code"></van-image>
		</van-popup>
...
export default {
	...
	created() {
        this.userWxQrUrl = localStorage.getItem("userWxQrUrl");
