<template>
	<div>
		...
		<ul>
			<li class="info-item" style="padding-bottom: 10px;">
				...
				style="position: relative;">
					<van-field
						...
						type="number"
						placeholder="总额（万元）" />
					<span style="color: gray;position:absolute;right:20px;">(万元)</span>
				</div>
			</li>
			<li class="info-item">
			...
			<li class="info-item" v-show="userChecked.zylx == 0 && this.tabBasicIndex != 3">
			...
			<li class="info-item" v-show="userChecked.zylx == 0 && this.tabBasicIndex == 1">
			...
			<!-- 单位/公司是否可考察 除了车贷 -->
			<li class="info-item"
			    v-show="this.tabBasicIndex !=3 && userChecked.zylx == 1 && userChecked.yyzznx != 1  && userChecked.yyzznx != -1">
			...
			<!--自顾 不显示 社保 + 公积金-->
			<div v-show="userChecked.zylx != 1 && userChecked.zylx != -1">
...
<style lang="scss" scoped>
	.input-money:not(:last-child)::after{
		border: none;
	}
</style>