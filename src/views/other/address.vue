<template>
    <div>
        <!--<iframe src="http://www.jierong123.com/dist/other/creditAddress.html"
                frameborder="0" style="display: block;height: 100vh;width: 100%;"></iframe>-->
        <div id="addlist">


            <div class='block' v-for="(item,i) in bankdata">
                <div class='itemcl'>
                    <div class='result_list' data-lng='" + bankdata[i]["longitude"] + "' data-lat='" + bankdata[i]["latitude"] + "' >
                        <div class='item_div'>
                            <div class='logo'>
                            <img src=' "http://file.jingyanit.com/loanlogo/" + bankdata[i][logo] + '></div>
                            <div class='list_info'>
                                <p>{{item.bankname}}</p>
<!--                                <div>-->
<!--                                    <span>{{bankdata[i]["address"]}}</span>-->
<!--                                    <span style='font-size: 12px;'>{{bankdata[i]["phone"]}}</span>-->
<!--                                </div>-->
                            </div>
<!--                            <div class='daohang' data-bankname='" + bankdata[i]["bankname"] + "' data-lng='" + bankdata[i]["longitude"] + "'-->
<!--                                 data-lat='" + bankdata[i]["latitude"] + "' data-address='" + bankdata[i]["address"] + "' >-->
<!--                                <i class='fa fa-paper-plane-o'></i>&nbsp;导航-->
<!--                            </div>-->
                        </div>
                    </div>
                </div>
...
<script>
	export default {
		...
		data() {
			return {
				bankdata : [
					{
						"bkn": "建设银行-英龙支行",
						"bankname": "建设银行-英龙支行（自助查询机）",
						"address": "深圳市福田区车公庙英龙大厦首层",
						"phone": "0755-83479481",
						"longitude": "22.534844",
						"latitude": "114.022569",
						"logo": "jsyh.png"
					...
					{
						"bkn": "招商银行-罗湖中心",
						"bankname": "招商银行-罗湖中心（自助查询机）",
						"address": "深圳市福田区深南中路1002新闻大厦一楼",
						"phone": "0755-82098610",
						"longitude": "22.541219",
						"latitude": "114.102675",
						"logo": "zsyh.png"
					...
					{
						"bkn": "建设银行-光明支行",
						"bankname": "建设银行-光明支行（自助查询机）",
						"address": "深圳市光明新区光明新地中央办公楼01号",
						"phone": "0755-27405118",
						"longitude": "22.761283",
						"latitude": "113.942775",
						"logo": "jsyh.png"
					...
					{
						"bkn": "珠江村镇银行",
						"bankname": "珠江村镇银行（自助查询机）",
						"address": "深圳市坪山区坪山街道六和商业广场一期165号",
						"phone": "0755-32833071",
						"longitude": "22.693634",
						"latitude": "114.339012",
						"logo": "zjcz.png"
					...
					{
						"bkn": "建设银行-民治支行",
						"bankname": "建设银行-民治支行（自助查询机）",
						"address": "深圳市龙华新区民治大道58号恒勤大厦一楼",
						"phone": "0755-29439266",
						"longitude": "22.610869",
						"latitude": "114.044656",
						"logo": "jsyh.png"
					...
					{
						"bkn": "招商银行",
						"bankname": "招商银行（柜台查询/自助查询机）",
						"address": "深圳市宝安区九区宝民一路广场大厦6楼601号",
						"phone": "0755-27875080",
						"longitude": "22.56333",
						"latitude": "113.900986",
						"logo": "zsyh.png"
					...
					{
						"bkn": "建设银行-吉华支行",
						"bankname": "建设银行-吉华支行（自助查询机）",
						"address": "深圳市龙岗区布吉街道中心花园商铺1楼",
						"phone": "0755-84275123",
						"longitude": "22.608747",
						"latitude": "114.130341",
						"logo": "jsyh.png"
					...
					{
						"bkn": "建设银行-盐田支行",
						"bankname": "建设银行-盐田支行（自助查询机）",
						"address": "深圳市盐田区深盐路壹海城一楼",
						"phone": "0755-25360662",
						"longitude": "22.554524",
						"latitude": "114.237322",
						"logo": "jsyh.png"
					...
					{
						"bkn": "建设银行-华侨城支行",
						"bankname": "建设银行-华侨城支行（自助查询机）",
						"address": "深圳市南山区华侨城湖滨花园裙楼建行",
						"phone": "0755-26606412",
						"longitude": "22.536049",
						"latitude": "113.98468",
						"logo": "jsyh.png"
					...
					{
						"bkn": "江苏银行-福田支行",
						"bankname": "江苏银行-福田支行（自助查询机）",
						"address": "深圳市福田区深南大道4011号港中旅大厦首层",
						"phone": "0755-22660721",
						"longitude": "22.538692",
						"latitude": "114.055634",
						"logo": "jsyh2.png"
					},
					{
						"bkn": "招商银行",
						"bankname": "招商银行（柜台查询/自助查询机）",
						"address": "深圳市福田区金田路3038号现代国际大厦1A",
						"phone": "0755-83663163",
						"longitude": "22.534241",
						"latitude": "114.06374",
						"logo": "zsyh.png"
					...
					{
						"bkn": "江苏银行-罗湖支行",
						"bankname": "江苏银行-罗湖支行（自助查询机）",
						"address": "深圳市罗湖区红宝路京基一百D栋金龙大厦一层",
						"phone": "0755-22915150",
						"longitude": "22.545201",
						"latitude": "114.107026",
						"logo": "jsyh2.png"
					...
					{
						"bkn": "深圳农村商业银行",
						"bankname": "深圳农村商业银行-营业部",
						"address": "深圳市罗湖区深南东路3038号合作金融大厦一层",
						"phone": "0755-25473807",
						"longitude": "22.543477",
						"latitude": "114.117408",
						"logo": "szncsyyh.png"
					...
					},
					{
						"bkn": "中信银行",
						"bankname": "中信银行-分行营业部",
						"address": "深圳市福田区中心三路8号卓越时代广场二期北座",
						"phone": "0755-23610522",
						"longitude": "22.534121",
						"latitude": "114.057131",
						"logo": "zxyy.png"
					...
					},
					{
						"bkn": "光大银行",
						"bankname": "光大银行-分行营业部",
						"address": "深圳市福田区竹子林思路紫竹七道18号光大大厦",
						"phone": "0755-88337039",
						"longitude": "22.534331",
						"latitude": "114.008348",
						"logo": "zggdyy.png"
					...
					{
						"bkn": "建设银行",
						"bankname": "建设银行-住房城市建设支行",
						"address": "深圳市福田区红岭中路银荔大厦一楼建行",
						"phone": "0755-25950825",
						"longitude": "22.547862",
						"latitude": "114.104144",
						"logo": "jsyh.png"
					...
					{
						"bkn": "珠海华润银行",
						"bankname": "珠海华润银行-华润城支行",
						"address": "深圳市南山区大冲商务中心C座101、102",
						"phone": "0755-86565867",
						"longitude": "22.541066",
						"latitude": "113.952959",
						"logo": "zghryy.png"
					...
					{
						"bkn": "邮政储蓄银行",
						"bankname": "邮政储蓄银行-西丽支行",
						"address": "深圳市南山区西丽南路47号一楼",
						"phone": "0755-86113873",
						"longitude": "22.575143",
						"latitude": "113.95298",
						"logo": "zgyzcxyy.png"
					},
					{
						"bkn": "兴业银行-宝安支行",
						"bankname": "兴业银行-宝安支行",
						"address": "深圳市宝安区裕安一路尚都花园2栋173-178号",
						"phone": "0755-29665617",
						"longitude": "22.559907",
						"latitude": "113.887273",
						"logo": "xyyy.png"
					...
					{
						"bkn": "中国银行-宝安支行",
						"bankname": "中国银行-宝安支行营业部",
						"address": "深圳市宝安中心区宝兴路21号万骏经贸大厦首层",
						"phone": "0755-22336882",
						"longitude": "22.549325",
						"latitude": "113.880493",
						"logo": "zgyy.png"
					...
					{
						"bkn": "中国银行-东部支行",
						"bankname": "中国银行-东部支行营业部",
						"address": "深圳市沙头角公园路59号天富花园大厦首层",
						"phone": "0755-22330326",
						"longitude": "22.548891",
						"latitude": "114.231561",
						"logo": "zgyy.png"
					},
					{
						"bkn": "中国人民银行",
						"bankname": "中国人民银行",
						"address": "深圳市深南东路5006号人民银行大厦南楼二楼",
						"phone": "0755-25590240-183",
						"longitude": "22.542422",
						"latitude": "114.107471",
						"logo": "zgrmyy.png"
					}
		...
		methods: {
			init(){
				let bankdata = this.bankdata;
				var map = new AMap.Map('container', {
					resizeEnable: true,
					center: [114.056489, 22.564602],
					zoom: 11
				});

				var marker = new AMap.Marker({
					position: [bankdata[i]["latitude"], bankdata[i]["longitude"]],
					icon: 'https://a.amap.com/jsapi_demos/static/demo-center/icons/poi-marker-default.png',
					offset: new AMap.Pixel(0, 0)
				});

				// 设置鼠标划过点标记显示的文字提示
				marker.setTitle(bankdata[i]["bkn"]);
				// 设置label标签
				// label默认蓝框白底左上角显示，样式className为：amap-marker-label
				marker.setLabel({
					offset: new AMap.Pixel(-80, -28),  //设置文本标注偏移量
					content: "<div class='info' style='width:130px;text-align:center; padding:5px;'>" + bankdata[i]["bkn"] + "</div>", //设置文本标注内容
