let userInfo = {
  ...
  zylx: [     //5.0、职业类型    新增
    { id: "zylx1", name: 0, value: "上班族" },
    { id: "zylx2", name: 1, value: "自雇(股东/其它)" }
  ],
  sb: [     //5.1、社保    新增
  ...
  ajjq: [
    ...
    { id: "ajjq1", name: 1, value: "3月以内" },
    { id: "ajjq2", name: 2, value: "6月以内" },
    { id: "ajjq3", name: 3, value: "1年以内" },
    { id: "ajjq4", name: 4, value: "其他" },
    // { id: "ajjq5", name: 5, value: "2年以上" }
  ],
  qkf: [  //23、全款房（过户时间）
  ...
  fl: [  //24、房龄
	...
	zzdycs: [  //25、深圳住宅抵押成数
    { id: "zzdycs1", name: 1, value: "低于9成" },
    { id: "zzdycs2", name: 2, value: "低于7成" },
    { id: "zzdycs3", name: 3, value: "其它" }
  ],
  ajc: [  //25、按揭车（按揭时间）
